    ...
    const renderSimulatorsSection = () => (
        <div className="w-full max-w-5xl animate-in slide-in-from-right-8 fade-in duration-500">
             <div className="flex items-center gap-4 md:gap-6 mb-6 md:mb-10">
                <button onClick={() => setLauncherSection('main')} className="p-3 md:p-4 rounded-2xl bg-white/40 dark:bg-white/10 text-slate-500 dark:text-slate-400 hover:text-black dark:hover:text-white transition-colors backdrop-blur-md shadow-sm dark:shadow-none border border-white/5" aria-label="Назад">
                    <ChevronLeft size={24}/>
                </button>
