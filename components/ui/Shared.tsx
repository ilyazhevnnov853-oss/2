        ...
        <div className="flex items-center gap-4">
            <div className="flex gap-2">
                <button
                    ...
                    className="p-2.5 rounded-2xl bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 text-slate-500 dark:text-slate-400 hover:text-black dark:hover:text-white transition-all active:scale-95 border border-transparent dark:border-white/5 focus-visible:ring-2 focus-visible:ring-blue-500"
                >
                    <Home size={18} />
                </button>
                {onBack && (
...
export const GlassButton = ({ onClick, icon, label, active, secondary, customClass, disabled, ariaLabel }: any) => {
    let base = "relative overflow-hidden group h-12 rounded-2xl flex items-center justify-center gap-2 transition-all font-bold text-xs uppercase tracking-wide shadow-md active:scale-95 focus-visible:ring-2 focus-visible:ring-blue-500 ";
