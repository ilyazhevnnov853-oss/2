...
// --- LIQUID BUTTON ---
export const GlassButton = ({ onClick, icon, label, active, secondary, customClass, disabled, ...props }: any) => {
    ...
    return (
        <button onClick={onClick} disabled={disabled} className={`${base} ${style}`} {...props}>
