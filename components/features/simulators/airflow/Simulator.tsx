...
const Simulator = ({ onBack, onHome }: any) => {
    ...
    const ToolButton = ({ active, icon, onClick, title }: any) => (
        <button 
            ...
            aria-label={title}
            className={`
                w-9 h-9 flex items-center justify-center rounded-full transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500
                ${active 
                ...
                <div className={`absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 w-[95%] max-w-2xl pointer-events-none transition-all duration-300 ${isHelpMode ? 'z-[210]' : 'z-40'}`}>
                    <div className="pointer-events-auto flex items-center p-1.5 rounded-full bg-white/80 dark:bg-[#0f1014]/90 backdrop-blur-2xl border border-black/5 dark:border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.6)]">
                        ...
                        <button 
                            ...
                            className={`w-11 h-11 flex items-center justify-center rounded-full transition-all mr-1 outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${isPowerOn ? 'bg-red-500 text-white shadow-lg shadow-red-500/30' : 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/30'} ${placedDiffusers.length === 0 ? 'opacity-50 cursor-not-allowed saturate-0' : ''}`}
                        ...
                        {isPowerOn && (
                            <button 
                                ...
                                className={`w-11 h-11 flex items-center justify-center rounded-full transition-all mr-1 outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${isPlaying ? 'bg-black/5 dark:bg-white/10 text-slate-900 dark:text-white hover:bg-black/10 dark:hover:bg-white/20' : 'bg-amber-500 text-white shadow-lg shadow-amber-500/30'}`}
                        ...
                        <button 
                            ...
                            className={`px-4 lg:px-5 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all flex items-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-blue-500
                        ...
                        <button 
                            ...
                            className={`px-4 lg:px-5 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all flex items-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${viewMode === 'top' ? 'bg-blue-600 text-white shadow-[0_4px_20px_rgba(37,99,235,0.4)]' : 'text-slate-500 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5'}`}
                            aria-label="План"
                        >
                                ...
                                {viewMode === 'top' && (
                                    <>
                                        ...
                                        <button 
                                            ...
                                            className={`w-11 h-11 flex items-center justify-center rounded-full transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${showHeatmap ? 'bg-orange-500/20 text-orange-600 dark:text-orange-400' : 'text-slate-500 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5'}`}
                                 ...
                                 <button onClick={handleExport} className={`w-11 h-11 flex items-center justify-center rounded-full transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500 text-slate-500 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5`} title="Экспорт" aria-label="Экспорт"><Download size={18} /></button>
                            </>
                        ) : null}
                        ...
                        <button 
                            onClick={toggleHelp} 
                            className={`w-11 h-11 flex items-center justify-center rounded-full transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${isHelpMode ? 'bg-cyan-500 text-white shadow-lg shadow-cyan-500/30' : 'text-slate-500 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5'}`}
                            title="Справка"
                            aria-label="Справка"
                        >
                            <CircleHelp size={18} />
