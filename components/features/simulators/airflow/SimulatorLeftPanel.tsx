                ...
                <div className="flex-1 flex flex-col h-full lg:rounded-[32px] bg-[#0a0a0f] lg:bg-[#0a0a0f]/80 backdrop-blur-2xl lg:border border-white/5 overflow-hidden ring-1 ring-white/5">
                    ...
                    <div className="p-5 lg:p-6 border-b border-white/5 bg-gradient-to-b from-white/5 to-transparent relative pt-safe-top">
                        ...
                        <div className="flex gap-1 mt-2 p-1 bg-black/40 rounded-xl border border-white/5">
                            <button onClick={() => setActiveTab('overview')} className={`flex-1 py-3 lg:py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === 'overview' ? 'bg-white/10 text-white shadow-lg' : 'text-slate-500 hover:text-white'}`}>Обзор</button>
                            <button onClick={() => setActiveTab('selection')} className={`flex-1 py-3 lg:py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all ${activeTab === 'selection' ? 'bg-white/10 text-white shadow-lg' : 'text-slate-500 hover:text-white'}`}>Подбор</button>
                        </div>
                    </div>
